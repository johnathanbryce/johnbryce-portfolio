...
import LineContentBreakHorizontal from '../../components/LineContentBreakHorizontal/LineContentBreakHorizontal';
...
const [isLoading, setIsLoading] = useState(true)
  ...
  return (
    ...
    <div>
        {/* renders loading page for 2.5 seconds then routes to About page + rest of page content */}
        { isLoading ?  
